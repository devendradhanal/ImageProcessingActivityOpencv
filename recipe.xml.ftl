...
<recipe>
    ...
    <!-- Copy files from root to output folder -->
    <copy from="res/drawable-hdpi/loading_image_border.jpg"
             to="${escapeXmlAttribute(resOut)}/drawable-hdpi/loading_image_border.jpg" />


    <instantiate from="src/app_package/CommonResource.java.ftl"
                    to="${escapeXmlAttribute(srcOut)}/CommonResource.java" />
